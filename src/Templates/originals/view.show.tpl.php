    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    [[if:i.type=='id']]
                    {!! Form::text('[[i.name]]', $[[model_singular]]->[[i.name]], ['class' => 'form-control', 'readonly'
                    => 'readonly'])!!}
                    [[endif]]
                    [[if:i.type=='text']]
                    {!! Form::text('[[i.name]]', $[[model_singular]]->[[i.name]], ['class' => 'form-control', 'readonly'
                    ...
                    [[endif]]
                    [[if:i.type=='number']]
                    {!! Form::number('[[i.name]]', $[[model_singular]]->[[i.name]], ['class' => 'form-control',
                    'readonly' => 'readonly'])!!}
                    [[endif]]
                    [[if:i.type=='related']]
                    {!! Form::text('[[i.name]]', $[[model_singular]]->[[i.relatedName]]->name, ['class' =>
                    'form-control', 'readonly' => 'readonly'])!!}
                    [[endif]]
                    [[if:i.type=='date']]
                    {!! Form::date('[[i.name]]', $[[model_singular]]->[[i.name]], ['class' => 'form-control', 'readonly'
                    => 'readonly'])!!}
                    [[endif]]
                    [[if:i.type=='textarea']]
                    {!! Form::textarea('[[i.name]]', $[[model_singular]]->[[i.name]], ['class' => 'form-control',
                    'readonly' => 'readonly'])!!}
                    [[endif]]
                    [[if:i.type=='unknown']]
                    {!! Form::text('[[i.name]]', $[[model_singular]]->[[i.name]], ['class' => 'form-control', 'readonly'
