<?php
//TODO Finish api template
namespace [[appns]]Http\Controllers\Api;
...
class [[controller_name]]Controller extends Controller
{
    ...
    public
    function __construct([[model_uc]] $model)
    {
...
{
    $[[model_singular]] = $this->model->all();


    return json_encode(['data' => $[[model_singular]]]);
